...
function medbeafgallery_display_statistics($stats) {
    ...
    <div class="medbeafgallery-admin-stats">
        <div class="medbeafgallery-stat-box">
            ...
            <span class="medbeafgallery-stat-number"><?php echo esc_html($stats['total_cases']); ?></span>
        ...
        <div class="medbeafgallery-stat-box">
            ...
            <span class="medbeafgallery-stat-number"><?php echo esc_html($stats['total_categories']); ?></span>
