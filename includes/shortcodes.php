...
function medbeafgallery_shortcode($atts) {
    ...
    wp_enqueue_script('medbeafgallery-js', MEDBEAFGALLERY_URL . 'assets/js/gallery.js', array('jquery'), MEDBEAFGALLERY_VERSION, true);
                ...
                <div class="medbeafgallery-comparison-container">
                    ...
                    <div class="medbeafgallery-image-sets-container">
                        <div class="medbeafgallery-before-after-wrapper active" data-pair-id="1">
                            <img id="medbeafgallery-before-img-1" src="" alt="Before" class="medbeafgallery-before-img">
                            <img id="medbeafgallery-after-img-1" src="" alt="After" class="medbeafgallery-after-img">
